...
goodness=rbind(initial_model = global.measure(initial_model),
               step_model = global.measure(step_model))

row.names(goodness) = c("Full model", "Reduced model")
...
In general, lower AIC is better and the difference between Residual Deviance and Null Deviance is larger for the full model. 


USE SIMPLE MODEL for simplicity
